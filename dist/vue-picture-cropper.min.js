...
!(function (t, e) {
    ...
    t.exports = (function () {
      ...
      function Jt(t, e, i, n) {
        var a = e.aspectRatio,
          ...
          W = z.getContext('2d'),
          H = Gt({ aspectRatio: m, width: D, height: B }),
          N = Gt({ aspectRatio: m, width: T, height: E }, 'cover'),
          R = Math.min(H.width, Math.max(N.width, g)),
          S = Math.min(H.height, Math.max(N.height, f)),
          L = Gt({ aspectRatio: a, width: D, height: B }),
          j = Gt({ aspectRatio: a, width: T, height: E }, 'cover'),
      ...
      var he = {
          ...
          limitCanvas: function (t, e) {
            ...
            if (t) {
              ...
              var d = Gt({ aspectRatio: h, width: c, height: p })
              ;(c = d.width),
                (p = d.height),
                (a.minWidth = c),
                (a.minHeight = p),
        ...
        ce = {
          bind: function () {
            ...
            bt(e.cropstart) && Yt(t, _, e.cropstart),
              ...
              Yt(i, Z, (this.onCropStart = this.cropStart.bind(this))),
              e.zoomable &&
                e.zoomOnWheel &&
            ...
            switch (h) {
              ...
              case A:
                if (s) {
                  ...
                  R(k), (l -= N.y), (p += N.y), (d = l * s), (c += o.width - d)
                } else
                  R(k),
                    R(C),
                    N.x <= 0
          ...
          setDragMode: function (t) {
            ...
            if (this.ready && !this.disabled) {
              ...
              ;(t = a || o ? t : I),
                ...
                zt(i, E, a),
                zt(i, S, o),
                e.cropBoxMovable || (Rt(n, L, t), zt(n, E, a), zt(n, S, o))
            }
            return this
          },
        },
                  ...
                  value: function () {
                    if (this.sized && !this.ready) {
                      ...
                      ;(this.container = n),
                        ...
                        e.highlight || Ot(c, N),
                        e.cropBoxMovable && (Ot(c, S), Rt(c, L, w)),
                        e.cropBoxResizable ||
                          (Ot(
                    ...
                    return n(this, function (n) {
                      switch (n.label) {
                        ...
                        case 1:
                          return (
                            (r = n.sent()),
                            (h = new File([r], o, { type: this.mimeType })),
                            a(h),
                            [2]
                          )
                      }
  ...
  o(
    ...
    (r.__file = 'src/vue-picture-cropper.vue'),
    (t.default = r),
