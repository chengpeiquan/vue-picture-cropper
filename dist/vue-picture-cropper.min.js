...
!(function (t, e) {
  ...
  const a = 'function' == typeof atob,
    ...
    l = (t) => t.replace(/[^A-Za-z0-9\+\/]/g, ''),
    d = (t) => {
      if (((t = t.replace(/\s+/g, '')), !s.test(t)))
    ...
    u = a
      ...
      : d,
    m = o
      ? (t) => p(Buffer.from(t, 'base64'))
      : (t) => p(u(t), (t) => t.charCodeAt(0)),
    g = (t) => m(f(t)),
    f = (t) => l(t.replace(/[-_]/g, (t) => ('-' == t ? '+' : '/'))),
    v = g
  'undefined' != typeof globalThis
    ? globalThis
  ...
  var w = (function (t, e, i) {
    ...
    t.exports = (function () {
      ...
      var u = 'undefined' != typeof window && void 0 !== window.document,
        ...
        V = g ? 'touchend touchcancel' : 'mouseup',
        $ = f ? 'pointerdown' : F,
        G = f ? 'pointermove' : Q,
        K = f ? 'pointerup pointercancel' : V,
        J = 'ready',
        tt = 'resize',
        et = 'wheel',
        it = 'zoom',
      ...
      function Jt(t, e, i, n) {
        var a = e.aspectRatio,
          ...
          W = z.getContext('2d'),
          H = Gt({ aspectRatio: m, width: D, height: k }),
          N = Gt({ aspectRatio: m, width: T, height: O }, 'cover'),
          S = Math.min(H.width, Math.max(N.width, g)),
          L = Math.min(H.height, Math.max(N.height, f)),
          R = Gt({ aspectRatio: a, width: D, height: k }),
          X = Gt({ aspectRatio: a, width: T, height: O }, 'cover'),
      ...
      var he = {
          ...
          limitCanvas: function (t, e) {
            ...
            if (t) {
              ...
              var l = Gt({ aspectRatio: h, width: c, height: p })
              ;(c = l.width),
                (p = l.height),
                (a.minWidth = c),
                (a.minHeight = p),
              ...
              if (r > (s ? 0 : 1)) {
                ...
                ;(a.minLeft = Math.min(0, d)),
                  ...
                  s &&
                    ...
                    (a.minTop = Math.min(o.top, o.top + (o.height - a.height))),
                    (a.maxLeft = o.left),
                    (a.maxTop = o.top),
                    2 === r &&
                      (a.width >= n.width &&
            ...
            e &&
              (r
                ? ((o.minLeft = Math.max(0, a.left)),
                  ...
                  (o.maxTop = Math.min(n.height, a.top + a.height) - o.height))
                : ((o.minLeft = 0),
                  (o.minTop = 0),
        ...
        ce = {
          bind: function () {
            ...
            bt(e.cropstart) && jt(t, _, e.cropstart),
              ...
              jt(i, $, (this.onCropStart = this.cropStart.bind(this))),
              e.zoomable &&
                e.zoomOnWheel &&
              ...
              e.toggleDragModeOnDblclick &&
                jt(i, Z, (this.onDblclick = this.dblclick.bind(this))),
              jt(
                t.ownerDocument,
                G,
          ...
          unbind: function () {
            ...
            bt(e.cropstart) && Yt(t, _, e.cropstart),
              ...
              e.toggleDragModeOnDblclick && Yt(i, Z, this.onDblclick),
              Yt(t.ownerDocument, G, this.onCropMove),
          ...
          cropStart: function (t) {
            ...
            if (
              ...
              t.changedTouches
                ...
                : (o[t.pointerId || 0] = Vt(t)),
                (n =
                  Object.keys(o).length > 1 && a.zoomable && a.zoomOnTouch
                    ? x
                    : Nt(t.target, R)),
                at.test(n) &&
                  !1 !== It(this.element, _, { originalEvent: t, action: n }) &&
                  (t.preventDefault(),
                  (this.action = n),
                  (this.cropping = !1),
            ...
            if (!this.disabled && e) {
              ...
              t.preventDefault(),
                !1 !== It(this.element, q, { originalEvent: t, action: e }) &&
                  (t.changedTouches
                    ? Mt(t.changedTouches, function (t) {
                        Ct(i[t.identifier] || {}, Vt(t, !0))
                      })
                    : Ct(i[t.pointerId || 0] || {}, Vt(t, !0)),
                  this.change(t))
            }
          },
          cropEnd: function (t) {
            ...
            switch (h) {
              ...
              case B:
                if (s) {
                  ...
                  S(A), (d -= N.y), (p += N.y), (l = d * s), (c += o.width - l)
                } else
                  S(A),
                    S(C),
                    N.x <= 0
        ...
        de = {
          ...
          clear: function () {
            return (
              this.cropped &&
                !this.disabled &&
                (Ct(this.cropBoxData, { left: 0, top: 0, width: 0, height: 0 }),
                (this.cropped = !1),
                this.renderCropBox(),
                this.limitCanvas(!0, !0),
                this.renderCanvas(),
  ...
  var y = e.defineComponent({
    ...
    methods: {
      ...
      updateInstance: function () {
        ;(t.cropper = this.cropper),
          (t.cropper.getDataURL = this.getDataURL),
          (t.cropper.getBlob = this.getBlob),
          (t.cropper.getFile = this.getFile)
      },
  ...
  b(
    ...
    (y.__file = 'src/vue-picture-cropper.vue'),
    (t.default = y),
