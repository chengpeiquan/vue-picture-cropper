...
!(function (t, e) {
          ...
          renderImage: function (t) {
            ...
            Ct(i, {
              ...
              At(
                ...
                Ct(
                  { width: i.width, height: i.height },
                  Vt(Ct({ translateX: i.left, translateY: i.top }, i))
                )
              ),
              t && this.output()
          },
          ...
          preview: function () {
            ...
            this.cropped &&
              ...
              (At(
                ...
                Ct(
                  { width: o, height: r },
                  Vt(Ct({ translateX: -h, translateY: -s }, t))
                )
              ),
                ...
                n && (d = a * (u = c / n)),
                  ...
                  At(
                    ...
                    Ct(
                      ...
                      Vt(Ct({ translateX: -h * u, translateY: -s * u }, t))
                    )
                  )
              }))
          },
        ...
        ce = {
          bind: function () {
            ...
            bt(e.cropstart) && jt(t, _, e.cropstart),
              ...
              jt(i, F, (this.onCropStart = this.cropStart.bind(this))),
              e.zoomable &&
                e.zoomOnWheel &&
  ...
  var r = e.defineComponent({
    ...
    methods: {
      ...
      getBlob: function (e) {
        var i = t.cropper.getDataURL()
        if (!i) return null
        for (
          var n = i.split(','),
            a = n[1].substring(0, n[1].length - 2),
            o = window.atob(a),
            r = o.length,
            h = new Uint8Array(r);
          r--;
          ...
          h[r] = o.charCodeAt(r)
        return new Blob([h], { type: this.mimeType })
      },
    },
  })
  o(
