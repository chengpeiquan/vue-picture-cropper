        ...
        ce = {
          bind: function () {
            var t = this.element,
              e = this.options,
              i = this.cropper
            bt(e.cropstart) && Yt(t, q, e.cropstart),
              bt(e.cropmove) && Yt(t, _, e.cropmove),
          ...
          unbind: function () {
            var t = this.element,
              e = this.options,
              i = this.cropper
            bt(e.cropstart) && Xt(t, q, e.cropstart),
              bt(e.cropmove) && Xt(t, _, e.cropmove),
        ...
        pe = {
              ...
              t.changedTouches
                ...
                (n =
                  Object.keys(o).length > 1 && a.zoomable && a.zoomOnTouch
                    ...
                    : Nt(t.target, L)),
                at.test(n) &&
                  !1 !== It(this.element, q, { originalEvent: t, action: n }) &&
                  (t.preventDefault(),
                  (this.action = n),
                  (this.cropping = !1),
          ...
          cropMove: function (t) {
            ...
            if (!this.disabled && e) {
              var i = this.pointers
              t.preventDefault(),
                !1 !== It(this.element, _, { originalEvent: t, action: e }) &&
                  (t.changedTouches
                    ? Mt(t.changedTouches, function (t) {
            ...
            switch (h) {
              ...
              case A:
                if (s) {
                  ...
                  R(k), (d -= N.y), (p += N.y), (l = d * s), (c += o.width - l)
                } else
                  R(k),
                    R(C),
                    N.x <= 0
