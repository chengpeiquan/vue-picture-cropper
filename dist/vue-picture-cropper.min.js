    ...
    t.exports = (function () {
      ...
      function Jt(t, e, i, n) {
        var a = e.aspectRatio,
          ...
          W = z.getContext('2d'),
          S = Gt({ aspectRatio: m, width: D, height: B }),
          H = Gt({ aspectRatio: m, width: T, height: E }, 'cover'),
          N = Math.min(S.width, Math.max(H.width, g)),
          R = Math.min(S.height, Math.max(H.height, f)),
            ...
            switch (h) {
              ...
              case A:
                if (s) {
                  ...
                  N(k), (l -= H.y), (p += H.y), (d = l * s), (c += o.width - d)
                } else
                  N(k),
                    N(C),
                    H.x <= 0
          ...
          setDragMode: function (t) {
            ...
            if (this.ready && !this.disabled) {
              ...
              ;(t = a || o ? t : I),
                ...
                zt(i, E, a),
                zt(i, R, o),
                e.cropBoxMovable || (Nt(n, L, t), zt(n, E, a), zt(n, R, o))
            }
            return this
          },
        },
                  ...
                  value: function () {
                    if (this.sized && !this.ready) {
                      ...
                      ;(this.container = n),
                        ...
                        e.highlight || Ot(c, H),
                        e.cropBoxMovable && (Ot(c, R), Nt(c, L, w)),
                        e.cropBoxResizable ||
                          (Ot(
