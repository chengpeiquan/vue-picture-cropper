    ...
    t.exports = (function () {
      ...
      function Jt(t, e, i, n) {
        var a = e.aspectRatio,
          ...
          S = Gt({ aspectRatio: a, width: D, height: B }),
          X = Gt({ aspectRatio: a, width: T, height: E }, 'cover'),
        ...
        ce = {
          bind: function () {
            ...
            bt(e.cropstart) && jt(t, _, e.cropstart),
              ...
              jt(i, Z, (this.onCropStart = this.cropStart.bind(this))),
              e.zoomable &&
                e.zoomOnWheel &&
            ...
            switch (h) {
              ...
              case A:
                if (s) {
                  ...
                  L(k), (d -= N.y), (p += N.y), (l = d * s), (c += o.width - l)
                } else
                  L(k),
                    L(C),
                    N.x <= 0
