  ...
  var VuePictureCropper = vue.defineComponent({
    ...
    methods: {
      ...
      getFile: function (options) {
        ...
        var optFileName = options.fileName
        var suffix = this.mimeType.replace(/image\//, '')
        var fileName = optFileName
          ? optFileName + '.' + suffix
