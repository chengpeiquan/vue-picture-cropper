 ...
 */
 (function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.vuePictureCropper = {}, global.Vue));
    ...
    ***************************************************************************** */
        ...
        methods: {
                        ...
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                check = window.setInterval(function () {
                                    var imgElement = _this.randomId
                                        ? document.querySelector("#vpc-img-" + _this.randomId)
            ...
            usePresetMode: function () {
                if (Object.prototype.toString.call(this.presetMode) !== '[object Object]')
                    return;
                var _a = this.presetMode, mode = _a.mode, width = _a.width, height = _a.height;
                switch (mode) {
                    case 'fixedSize':
                    case 'round': {
                    ...
                    return __generator(this, function (_a) {
                        return [2, new Promise(function (resolve) {
                                (function () { return __awaiter(_this, void 0, void 0, function () {
                                    var optFileName, suffix, fileName, blob, file;
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0:
                                                optFileName = options.fileName;
                                                suffix = this.mimeType.replace(/image\//, '');
                                                fileName = optFileName
                                                    ? optFileName + "." + suffix
                                                    : "cropped-" + Date.now() + "." + suffix;
                                                return [4, this.getBlob(options)];
                                            case 1:
                                                blob = _a.sent();
            ...
            getRoundedCanvas: function (sourceCanvas) {
                var canvas = document.createElement('canvas');
                var context = canvas.getContext('2d');
                var width = sourceCanvas.width, height = sourceCanvas.height;
                canvas.width = width;
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      return (vue.openBlock(), vue.createBlock("div", {
        id: `vpc-wrap-${_ctx.randomId}`,
        class: ["vue--picture-cropper__wrap", { 'vue--picture-cropper__wrap-round': _ctx.presetMode.mode === 'round' }],
        style: _ctx.boxStyle
      }, [
        vue.createVNode("img", {
          class: "vue--picture-cropper__img",
          src: _ctx.imgSrc,
          id: _ctx.randomId ? `vpc-img-${_ctx.randomId}` : null
        }, null, 8 /* PROPS */, ["src", "id"])
