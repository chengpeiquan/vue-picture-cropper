    ...
    ((function (t, e) {
      ...
      t.exports = (function () {
        ...
        var u = 'undefined' != typeof window && void 0 !== window.document,
          ...
          _ = 'cropstart',
          F = 'dblclick',
          Q = g ? 'touchstart' : 'mousedown',
          $ = g ? 'touchmove' : 'mousemove',
          Z = g ? 'touchend touchcancel' : 'mouseup',
          G = f ? 'pointerdown' : Q,
          V = f ? 'pointermove' : $,
          K = f ? 'pointerup pointercancel' : Z,
          J = 'ready',
          tt = 'resize',
          et = 'wheel',
          it = 'zoom',
          ...
          lt = Number.isNaN || m.isNaN
        function ut(t) {
          return 'number' == typeof t && !lt(t)
        }
        var mt = function (t) {
          return t > 0 && t < 1 / 0
        }
        ...
        var Bt = /^width|height|left|top|marginLeft|marginTop$/
        function At(t, e) {
          var i = t.style
          Mt(e, function (t, e) {
            Bt.test(e) && ut(t) && (t = ''.concat(t, 'px')), (i[e] = t)
          })
        }
        function Tt(t, e) {
          return t.classList
        ...
        function _t(t) {
          ...
          return (
            null !== e &&
            (e[1] !== Ut.protocol || e[2] !== Ut.hostname || e[3] !== Ut.port)
          )
        }
        function Ft(t) {
        ...
        function Jt(t, e, i, n) {
          var a = e.aspectRatio,
            ...
            S = Math.min(H.width, Math.max(R.width, g)),
            N = Math.min(H.height, Math.max(R.height, f)),
          ...
          try {
            ...
            if (o) {
              var d,
                ...
                u = i.getUint16(o, n)
              for (l = 0; l < u; l += 1)
                if (((d = o + 12 * l + 2), 274 === i.getUint16(d, n))) {
        ...
        var he = {
            ...
            initContainer: function () {
              ...
              ;(this.containerData = r),
                At(n, { width: r.width, height: r.height }),
                Ot(t, W),
                Et(n, W)
            },
            initCanvas: function () {
            ...
            limitCanvas: function (t, e) {
              ...
              if (t) {
                ...
                var d = Vt({ aspectRatio: h, width: c, height: p })
                ;(c = d.width),
                  (p = d.height),
                  (a.minWidth = c),
                  (a.minHeight = p),
              ...
              if (e)
                if (r > (s ? 0 : 1)) {
                  var l = n.width - a.width,
                    u = n.height - a.height
                  ;(a.minLeft = Math.min(0, l)),
                    (a.minTop = Math.min(0, u)),
                    (a.maxLeft = Math.max(0, l)),
              ...
              ;(i.width > i.maxWidth || i.width < i.minWidth) &&
                ...
                At(
                  ...
                  Ct(
                    ...
                    Qt({ translateX: i.left, translateY: i.top })
                  )
                ),
                this.renderImage(t),
            ...
            renderImage: function (t) {
              ...
              Ct(i, {
                ...
                At(
                  ...
                  Ct(
                    { width: i.width, height: i.height },
                    Qt(Ct({ translateX: i.left, translateY: i.top }, i))
                  )
                ),
                t && this.output()
            },
            ...
            output: function () {
              this.preview(), It(this.element, P, this.getData())
            },
          },
          se = {
            ...
            preview: function () {
              ...
              this.cropped &&
                ...
                (At(
                  ...
                  Ct(
                    { width: o, height: r },
                    Qt(Ct({ translateX: -h, translateY: -s }, t))
                  )
                ),
                Mt(this.previews, function (e) {
                  ...
                  n && (l = a * (u = c / n)),
                    a && l > p && ((d = n * (u = p / a)), (l = p)),
                    At(e, { width: d, height: l }),
                    At(
                      e.getElementsByTagName('img')[0],
                      Ct(
                        { width: o * u, height: r * u },
                        Qt(Ct({ translateX: -h * u, translateY: -s * u }, t))
                      )
                    )
                }))
            },
              ...
              if (!this.disabled && e) {
                ...
                t.preventDefault(),
                  !1 !== It(this.element, q, { originalEvent: t, action: e }) &&
                    (t.changedTouches
                      ? Mt(t.changedTouches, function (t) {
                          Ct(i[t.identifier] || {}, Zt(t, !0))
                        })
                      : Ct(i[t.pointerId || 0] || {}, Zt(t, !0)),
                    this.change(t))
              }
            },
            cropEnd: function (t) {
          ...
          le = {
            ...
            zoomTo: function (t, e, i) {
              ...
              if (
                ...
                if (i) {
                  ...
                  ;(a.left -= (c - o) * ((u.pageX - l.left - a.left) / o)),
                    (a.top -= (p - r) * ((u.pageY - l.top - a.top) / r))
                } else
                  wt(e) && ut(e.x) && ut(e.y)
            ...
            getCroppedCanvas: function () {
              ...
              ;(m = Math.min(d.width, Math.max(l.width, m))),
                (g = Math.min(d.height, Math.max(l.height, g)))
              ...
              O <= -r || O > A
                ? ((O = 0), (y = 0), (C = 0), (k = 0))
                : O <= 0
                ? ((C = -O), (O = 0), (k = y = Math.min(A, r + O)))
                : O <= A && ((C = 0), (k = y = Math.min(r, A - O))),
                y <= 0 || E <= -s || E > T
                  ? ((E = 0), (M = 0), (D = 0), (B = 0))
                  : E <= 0
                  ? ((D = -E), (E = 0), (B = M = Math.min(T, s + E)))
                  : E <= T && ((D = 0), (B = M = Math.min(s, T - E)))
              var z = [O, E, y, M]
              if (k > 0 && B > 0) {
                var W = m / r
                z.push(C * W, D * W, k * W, B * W)
              }
              return (
                v.drawImage.apply(
                  v,
            ...
            setDragMode: function (t) {
              ...
              if (this.ready && !this.disabled) {
                ...
                ;(t = a || o ? t : I),
                  ...
                  zt(i, E, a),
                  zt(i, N, o),
                  e.cropBoxMovable || (St(n, L, t), zt(n, E, a), zt(n, N, o))
              }
              return this
            },
          },
                    ...
                    value: function () {
                      if (this.sized && !this.ready) {
                        ...
                        ;(this.container = n),
                          ...
                          e.highlight || Ot(c, R),
                          e.cropBoxMovable && (Ot(c, N), St(c, L, w)),
                          e.cropBoxResizable ||
                            (Ot(
        ...
        return Ct(me.prototype, he, se, ce, pe, de, le), me
      })()
    })(
      (h = {
        path: r,
...
var p = null,
  d = t({
    ...
    data: function () {
      return { cropper: null, mimeType: '', randomId: '' }
    },
    watch: {
      img: function () {
        if (this.cropper)
          ...
          return o(this, function (i) {
            switch (i.label) {
              ...
              case 1:
                return (
                  i.sent(),
                  (this.randomId = (function (t) {
                    void 0 === t && (t = 10)
                    for (
                      var e =
                          'ABCDEFGHJKMNPQRSTWXYZabcdefhijkmnprstwxyz012345678',
                        i = e.length,
                        n = '',
                        a = 0;
                      a < t;
                  ...
                  (t = window.setInterval(function () {
                    var i = e.randomId
                      ? document.querySelector('#vpc-img-' + e.randomId)
                    ...
                    return o(this, function (o) {
                      switch (o.label) {
                        ...
                        case 1:
                          return (
                            (r = o.sent()),
                            (h = new File([r], a, { type: this.mimeType })),
                            i(h),
                            [2]
                          )
                      }
