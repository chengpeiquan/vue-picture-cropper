...
- [使用组合式 API](https://github.com/chengpeiquan/vue-picture-cropper/blob/v0.7.0/docs/components/WithCompositionAPI.vue) （适合熟悉 Vue 3 风格的开发者）
- [使用选项式 API](https://github.com/chengpeiquan/vue-picture-cropper/blob/v0.7.0/docs/components/WithOptionsAPI.vue) （适合习惯 Vue 2 风格的开发者）

## 多个裁剪框

从 `0.5.0` 版本开始支持在同一个页面里使用多个裁剪框，无需额外配置，可在 [多个裁剪框 demo](https://github.com/chengpeiquan/vue-picture-cropper/blob/v0.7.0/docs/components/MultipleCropper.vue) 体验并参考 demo 源码使用。
