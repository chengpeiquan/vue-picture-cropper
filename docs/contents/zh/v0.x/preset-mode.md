...
点击查看：[在线演示](https://github.com/chengpeiquan/vue-picture-cropper/blob/v0.7.0/docs/components/FixedSizeMode.vue)
...
点击查看：[在线演示](https://github.com/chengpeiquan/vue-picture-cropper/blob/v0.7.0/docs/components/RoundMode.vue)
