...
:::danger Deprecated
The document you are currently viewing is for an older version (v0.x). It is recommended to use the latest version.
:::

Because this plugin is a Vue component wrapper for Cropper.js, all APIs of Cropper.js are synchronized.

This document only records the properties and methods of component extensions. If you need more advanced functions, you can use the original Cropper.js API through the cropper instance. Click to read [Cropper.js API Documentation](https://github.com/fengyuanchen/cropperjs/tree/v1.6.2#cropperjs).
...
Option parameters passed to Cropper.js, for a complete list of options, please refer to [Cropper.js Options Documentation](https://github.com/fengyuanchen/cropperjs/tree/v1.6.2#options) .
...
Events passed to Cropper.js, each event is bound using `v-on:` or `@`, similar to the component Emits, for a complete list of events, please refer to [Cropper.js event documentation](https://github.com/fengyuanchen/cropperjs/tree/v1.6.2#events) 。
...
export interface CropperInstance extends Cropper {
   ...
   *
   * Can be used for local preview display
   */
   ...
   *
   * Can be used to pass to the server
   */
...
If you need to convert formats or process remote images, please use the [getCroppedCanvas](https://github.com/fengyuanchen/cropperjs/tree/v1.6.2#getcroppedcanvasoptions) API, it provided by Cropper.js. This method has some asynchronous operations, please pay attention to the usage instructions.
