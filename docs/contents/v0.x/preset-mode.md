...
Click to view: [Live Demo](https://github.com/chengpeiquan/vue-picture-cropper/blob/v0.7.0/docs/components/FixedSizeMode.vue)
...
Click to view: [Live Demo](https://github.com/chengpeiquan/vue-picture-cropper/blob/v0.7.0/docs/components/RoundMode.vue)
