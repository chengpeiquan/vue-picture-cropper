...
- [With Composition API](https://github.com/chengpeiquan/vue-picture-cropper/blob/v0.7.0/docs/components/WithCompositionAPI.vue) (suitable for developers familiar with the Vue 3 syntaxes)
- [With Options API](https://github.com/chengpeiquan/vue-picture-cropper/blob/v0.7.0/docs/components/WithOptionsAPI.vue) (suitable for developers accustomed to Vue 2 syntaxes)

## Multiple Cropper

Since `0.5.0` version, multiple cropper can be used in the same page without additional configuration. You can experience it in [Multiple Cropper demo](https://github.com/chengpeiquan/vue-picture-cropper/blob/v0.7.0/docs/components/MultipleCropper.vue) and refer to the demo source code.
